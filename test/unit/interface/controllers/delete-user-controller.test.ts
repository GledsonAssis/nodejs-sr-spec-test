...
import { DeleteUserController } from "@/interfaces/controllers";
...
describe("DeleteUserController", () => {
  let createUserController: DeleteUserController;
  let mockUsecase: jest.Mocked<DeleteUser>;
  let mockInputValidator: jest.Mocked<InputValidator>;

  beforeEach(() => {
    mockUsecase = new (require("@/application/usecases").DeleteUser)();

    createUserController = new DeleteUserController();
